...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-------------+------+------+------+------| Space|------+------+------+ Enter|------+------+------+------+-------------|
     * |      |  GUI |  ALt |  GUI |||||||| Lower|      |  Del |||||||| Bksp |      | Raise||||||||ALT_TB|GUI_RT|GUI_UP|K8SCTL|
     * ,----------------------------------------------------------------------------------------------------------------------.
     */
    [_QWERTY] = LAYOUT( \
      ...
      _______, KC_LGUI, KC_LALT, KC_LGUI,          LOWER,   KC_SPC , KC_DEL,       KC_BSPC, KC_ENT , RAISE,            ALT_TB,  GUI_RT,  GUI_UP,  K8SCTL   \
    ),
